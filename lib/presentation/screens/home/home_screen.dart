...
import 'package:vocalis/presentation/bloc/home/home_bloc.dart'; // Importa el BLoC desde su nueva ubicación
import 'package:vocalis/presentation/screens/lesson_detail/lesson_detail_screen.dart';

// ¡YA NO HAY CÓDIGO DE BLOC AQUÍ!
                ...
                child: _LessonCard(
                  ...
                  onTap: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (_) => LessonDetailScreen(category: category)));
                  },
                ),
              ),
              const SizedBox(width: 16),
              const Expanded(child: _LessonCard(isLocked: true)),
            ],
          ),
        ],
      ),
...
class _LessonCard extends StatelessWidget {
  ...
  const _LessonCard({this.level, this.progress = 0.0, this.isLocked = false, this.onTap});
